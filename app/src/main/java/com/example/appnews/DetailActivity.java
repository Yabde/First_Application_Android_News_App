...
import static com.example.appnews.MainActivity.Extra_buton_webview;
...
public class DetailActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String create_author = intent.getStringExtra(Extra_author);
        ...
        final String create_webview = intent.getStringExtra(Extra_buton_webview);
        ...
        Button btnOpenWebView = findViewById(R.id.button_webview);
        ...
        //On va loader la Web View en cliquant sur le boutan : Permet d'envoyer l'url et de lancer la nouvelle ACTIVITE
        btnOpenWebView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webIntent.putExtra("url", create_webview);
